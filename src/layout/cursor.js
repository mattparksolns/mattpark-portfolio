...
const Cursor = withStyles(theme => ({
  ...
  useEffect(() => {
    ...
    document.body.addEventListener('mousemove', e => {
      ...
      document.querySelector('.innerMouseIndicator').style.left = `${mouseX}px`
      document.querySelector('.innerMouseIndicator').style.top = `${mouseY}px`
  ...
  return (
    <>
      ...
      <div className={`${classes.innerMouseIndicator} innerMouseIndicator`} />
    </>
  )
})
