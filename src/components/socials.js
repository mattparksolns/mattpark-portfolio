...
const Socials = (props) => {
  ...
  return (
    <div {...props}>
      <Link title="Twitter" target="_blank" rel="noopener noreferrer"
            href={socials.twitter.link}><SvgIcon component={TwitterIcon} viewBox={"0 -47 512.00004 512"} /></Link>
      <Link title="LinkedIn" target="_blank" rel="noopener noreferrer"
            href={socials.linkedin.link}><SvgIcon component={LinkedInIcon} viewBox={"0 0 24 24"} /></Link>
      <Link title="GitHub" target="_blank" rel="noopener noreferrer"
            href={socials.github.link}><SvgIcon component={GitHubIcon} viewBox={"0 0 24 24"} /></Link>
    </div>
  )
}
