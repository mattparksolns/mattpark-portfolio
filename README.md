...
1.  **Open the source code and start editing!**
    ...
    Open the `my-default-starter` directory in your code editor of choice and edit `src/pages/index-old.js`. Save your changes and the browser will update in real time!
